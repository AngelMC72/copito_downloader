"""
Copito_Downloader_v1.0

Download all videos from a csv file.
Video files will be created in the same folder of this script.
...
## Open "paste_here.csv" and paste the links on "id" column.
...
ans = input("""
Optional:   Would you like to I create folders 
            in order to organize your downloaded files?
(y/n)?

""")
if ans == "y":
    link = input("""
Please, give me the link of the MasterGIS website
